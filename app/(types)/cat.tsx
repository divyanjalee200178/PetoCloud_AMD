...
import { catStyles as styles } from "@/styles/catStyles"; // 🟢 separate styles file
import { useRouter } from "expo-router";

// Define Cat Type
type CatKey = "persian" | "siamese" | "mainecoon" | "bengal";
...
const catDetails: Record<CatKey, CatInfo> = {
  persian: {
    title: "Persian Cat",
    description:
      "Long-haired, calm, and affectionate cats with a royal look.",
    image:
      "https://cdn.pixabay.com/photo/2017/11/09/21/41/persian-cat-2934720_1280.jpg",
    info: {
  ...
  siamese: {
    title: "Siamese Cat",
    description:
      "Elegant, talkative, and affectionate cats with striking blue eyes.",
    image:
  ...
  mainecoon: {
    title: "Maine Coon",
    description:
      "Gentle giants, friendly and social, one of the largest domestic cats.",
    image:
      "https://cdn.pixabay.com/photo/2015/03/27/13/10/cat-694718_1280.jpg",
    info: {
  ...
  bengal: {
    title: "Bengal Cat",
    description:
      "Energetic, playful, and wild-looking cats with leopard-like spots.",
    image:
      "https://img.freepik.com/premium-photo/ravishing-studio-portrait-bengal-cat-isolated-background_31965-141485.jpg",
    info: {
...
const CatPage = () => {
    ...
    <View style={styles.listContainer}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroSection}>
          ...
          <Image
            source={{
              uri: "https://www.zastavki.com/pictures/1920x1200/2012/Animals_Cats_Beautiful_kitten_033169_.jpg",
            }}
        ...
        {Object.keys(catDetails).map((key) => {
          ...
          return (
            ...
            >
              <Image
                source={{ uri: catDetails[catKey].image }}
                style={styles.breedImage}
              />
              <View style={styles.breedContent}>
                <Text style={styles.breedName}>
                  {catDetails[catKey].title}
                </Text>
                <Text style={styles.breedDescription}>
                  {catDetails[catKey].description.substring(0, 50)}...
                </Text>
              </View>
              <Icon
  ...
  // Cat Details
  const renderCatDetails = (catKey: CatKey) => {
            ...
            {Object.entries(details.info).map(([label, value], idx) => (
              <View key={idx} style={styles.serviceItem}>
                <View style={styles.serviceIcon}>
                  <Icon name={getCatInfoIcon(label)} size={16} color="#FF6B35" />
                </View>
